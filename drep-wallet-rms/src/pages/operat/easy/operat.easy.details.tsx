...
import './style/operat.easy.details.scss';
...
class OperatEasyDetails extends React.Component {
    constructor(props: {}) {
        super(props);
        this.state = {
    ...
    render() {
        return (
            <div className="page-OperatEasyDetails">
...
export default OperatEasyDetails;