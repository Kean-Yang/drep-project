...
describe('drep.eth.contract', function() {
    it('should create simple contract with one method from abi with explicit type name', function () {
        ...
        // when
        var drep = new Drep();
        var myCon = drep.eth.contract(description).at(address);
    ...
    it('should create contract with nondefault constructor', function (done) {
        ...
        drep.eth.contract(description).new(2, {from: address, data: code}, function(e, myCon){
                done();
                drep.stopWatching();
        });
    });
